<template>
<div>
   <v-container v-scroll="onScrollDown" :class="{ topFixBannerFixed : isScrolldown }"> 
       <v-layout
        align-center
        justify-center
        row 
        ...
        >
     <v-tabs fixed-tabs v-model="step" color="rgba(255, 255, 255, 0.0)" active-class="customselected" hide-slider=true > 
    <v-btn
        flat
        @click="prev"
    >
