...
<div class="company">
  ...
  >
     ...
     <v-img src="../../../static/img/introduction_01.jpg" aspect-ratio="2.75">
          <v-container fill-height fluid>
            <v-layout align-end fill-height>
              <v-flex sm5>
                <span class="headlineintro">{{introduction[0].title}}</span>
   ...
   <v-card-title>
    ...
    <div v-for="content in introduction[0].contents"
    :key="content.part">
    <p class="text-sm-left"><v-icon color="black">{{getIcon(content.part)}}</v-icon>
     {{content.content}}
     </p>
    </div>
    <br><br>
